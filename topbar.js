...
async function _testProviderKey(providerName, apiKey, cfg) {
  ...
  if (providerName === 'gemini') {
    fetchUrl = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash-lite:generateContent?key=' + apiKey;
  ...
  if (cfg2.testType === 'gemini') {
    ...
    return { model: 'gemini-2.0-flash', time: t1 - t0, reply: geminiText.slice(0, 30) };
  }
